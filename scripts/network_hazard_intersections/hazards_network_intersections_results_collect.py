...
def main():
    ...
    modes = ['road', 'rail','bridge', 'air', 'port'] # change this to your network datasets
    modes_shapefile_names = ['road_edges','rail_edges','bridge_edges','air_nodes','port_nodes'] # change this to your network datasets
    point_asset_modes = ['air', 'port'] # change this to your network point asset datasets
    line_asset_modes = ['road', 'rail','bridge'] # change this to your network line asset datasets
    modes_id_cols = ['edge_id','edge_id','bridge_id','node_id','node_id'] # This should match the ID column name in your network datasets
    climate_scenarios = ['historical','rcp4p5','rcp8p5'] # change this to GLOFRIS scenarios 
    ...
    hazard_description_file = os.path.join(data_path,
                            'flood_data','GLOFRIS',
                            'glofris_files.csv') # change this to the GLOFRIS data path and the csv file describing the data
