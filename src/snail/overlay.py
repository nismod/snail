...
def overlay_raster(
    ...
    raster : str | pathlib.Path | rasterio dataset
        Raster file path, or an open rasterio dataset, defining the splitting
        grid and providing cell values
    ...
    for band_number in bands:
        ...
        band_data = read_raster_band_data(raster, int(band_number))
...
def overlay_rasters(
    ...
    return associate_raster_files(splits, rasters)
